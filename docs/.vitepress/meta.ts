...
export const site = "https://cz-git.qbenben.com";
export const logo = "https://cz-git.qbenben.com/images/logo.png";
export const keywords = "cz-git, czg, cli, commitizen, commitizen cli,commitizen adapter, git-cz";
export const descriptionEN =
  "A more engineered, lightweight, customizable, standard output format commitizen adapter and CLI.";
