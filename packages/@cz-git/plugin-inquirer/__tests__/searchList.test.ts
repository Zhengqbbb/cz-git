...
describe('inquirer-SearchList', () => {
    ...
    describe('main behaviour', () => {
        describe('default behaviour', () => {
            it('default enter should be the first to selected item', async () => {
                prompt = new SearchList(
                    {
                        message: 'test',
                        name: 'name',
        ...
        describe('keyPress behaviour', () => {
            ...
            it('use keypress down should be normal', async () => {
                moveDown()
                enter()
                const answer = await promiseForAnswer.then()
            ...
            it('use tab and the cursor position should be right', async () => {
                tab()
                tab()
