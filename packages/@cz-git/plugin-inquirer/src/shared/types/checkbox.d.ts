...
export = ComplateCheckbox;

/**
 * Provides the functionality to create a new Inquirer plugin
 */
declare class ComplateCheckbox<T extends Answers> extends Base {
  /**
...
declare namespace ComplateCheckbox {
  /**
   ...
   */
  interface ComplateCheckboxQuestionOptions<T extends Answers = Answers> extends Question<T> {
    /**
