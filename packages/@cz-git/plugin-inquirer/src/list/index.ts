    ...
    // Render question
        ...
        if (this.status === 'answered') {
            content += this.themeColorCode
                ? style.rgb(this.themeColorCode)(this.answer as string)
                : style.cyan(this.answer as string)
        }
 ...
 */
function listRender(choices: ChoicesType['choices'], pointer: number, themeColorCode?: string): string {
    let output = ''
