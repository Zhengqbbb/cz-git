...
function generateSpyFn(opt: UserConfig) {
...
describe('generateOptions()', () => {
    ...
    it('generate default options should be equal default config', () => {
        expect(generateSpyFn({})).toEqual(defaultConfig)
    })

    it('v1.4.0 fix typo option. old field should be normal compatibility', () => {
